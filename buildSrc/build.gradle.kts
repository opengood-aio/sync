...
dependencies {
    implementation(
        "com.fasterxml.jackson.dataformat:jackson-dataformat-yaml:" +
            versionFor("com.fasterxml.jackson.dataformat..jackson-dataformat-yaml"),
    )
    implementation(
        "com.fasterxml.jackson.module:jackson-module-kotlin:" + versionFor("com.fasterxml.jackson.module..jackson-module-kotlin"),
    )
